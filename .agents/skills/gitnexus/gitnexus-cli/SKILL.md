...
Run from the project root. This parses all source files, builds the knowledge graph, writes it to `.gitnexus/`, and generates tool context files. The maintained repository guidance lives in `.Codex/skills/repo-guidelines/`.
