...
Check `.gitignore` first. New ad-hoc local artifacts should live under `.local/`. Existing compatibility runtime paths such as `storage/`, `logs/`, `local_data/`, `ComfyUI/output/`, and service-specific output directories are ignored.
