 ...
 *
 * Stages the LITE payload into app/electron/payload-lite/.
 *
 ...
 *
 * Bundled:
 *   - All Python source (services/, app/config|src|scripts|requirements|image_pipeline|configs_vps|rag/,
 *     ComfyUI/)
 *   - app/storage/character_db, app/storage/metadata, app/storage/prompts (small JSON/YAML)
 ...
 *   - app/storage/character_loras|character_refs|feature_layers|references
...
const EXCLUDE_SUBSTR = [
    ...
    '/app/storage/character_loras/',
    '/app/storage/character_refs/',
    '/app/storage/feature_layers/',
    '/app/storage/references/',
    '/private/',
