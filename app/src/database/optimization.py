...
MONGODB_INDEXES = {
    ...
    "memories": [
        ...
        {"keys": [("content", TEXT)], "name": "idx_content_text", "background": True},
        {
    ...
    "api_keys": [
        ...
        {"keys": [("is_active", ASCENDING)], "name": "idx_active", "background": True},
    ],
    "rate_limits": [
        {
            "keys": [("key", ASCENDING)],
...
class MongoDBConnectionManager:
    ...
    def connect(
        ...
        if self._client is None:
            ...
            logger.info(
                f"MongoDB connected with pool size {min_pool_size}-{max_pool_size}"
            )
