...
class HealthChecker:
    ...
    def register_check(
        ...
        """
        self._checks[name] = {"func": check_func, "critical": is_critical}
...
def check_mongodb(client, db_name: str = "ai_assistant") -> tuple:
    ...
    try:
        ...
        return True, "Connected", {"version": info.get("version"), "database": db_name}
    except Exception as e:
        return False, str(e), {}
...
def check_redis(redis_client) -> tuple:
    ...
    try:
        ...
        return True, "Connected", {"used_memory": info.get("used_memory_human")}
    except Exception as e:
        return False, str(e), {}
