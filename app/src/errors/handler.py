...
class DatabaseError(APIError):
    ...
    def __init__(self, message: str = None, original_error: Exception = None):
        super().__init__(
            ErrorCode.DATABASE_ERROR, message, original_error=original_error
        )
...
class ExternalAPIError(APIError):
    ...
    def __init__(
        self, service: str, message: str = None, original_error: Exception = None
    ):
        super().__init__(
...
class AIModelError(APIError):
    ...
    def __init__(
        self, model: str, message: str = None, original_error: Exception = None
    ):
        super().__init__(
...
def wrap_exception(
    ...
    """
    return APIError(
        error_code=error_code, message=message or str(error), original_error=error
    )
