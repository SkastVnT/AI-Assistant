...
def setup_logging(
    ...
    json_logs = (
        ...
        else os.getenv("JSON_LOGS", "").lower() == "true"
    )
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if log_result:
                    logger.log(level, f"{func_name} returned", extra={"result": result})
...
def log_execution_time(
    logger: logging.Logger = None, level: int = logging.INFO, threshold_ms: float = 0
):
    """
