...
class OutputTargets:
    ...
    output_dir: str = field(default_factory=lambda: str(STORAGE_DIR / "outputs"))
    metadata_dir: str = field(default_factory=lambda: str(STORAGE_DIR / "metadata"))
...
class RunMetadata:
    ...
    def add_stage_timing(
        self, stage: str, latency_ms: float, location: str = "api"
    ) -> None:
...
class ImageJob:
    ...
    def to_log_dict(self) -> dict:
        ...
        return {
            ...
            or self.final_image_url is not None,
        }
