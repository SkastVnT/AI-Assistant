...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Set the ComfyUI base directory for models, custom_nodes, input, output, temp, and user directories.",
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Set the ComfyUI output directory. Overrides --base-directory.",
)
parser.add_argument(
    "--temp-directory",
    type=str,
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Set the ComfyUI input directory. Overrides --base-directory.",
)
parser.add_argument(
    "--auto-launch",
    action="store_true",
...
parser.add_argument(
    "--enable-manager", action="store_true", help="Enable the ComfyUI-Manager feature."
)
manager_group = parser.add_mutually_exclusive_group()
manager_group.add_argument(
    "--disable-manager-ui",
    action="store_true",
    help="Disables only the ComfyUI-Manager UI and endpoints. Scheduled installations and similar background tasks will still operate.",
)
manager_group.add_argument(
    "--enable-manager-legacy-ui",
    action="store_true",
    help="Enables the legacy UI of ComfyUI-Manager",
)
...
parser.add_argument(
    "--disable-pinned-memory", action="store_true", help="Disable pinned memory use."
)
...
parser.add_argument(
    ...
    nargs="+",
    default=[],
    help="Specify custom node folders to load even when --disable-all-custom-nodes is enabled.",
)
parser.add_argument(
    "--disable-api-nodes",
    action="store_true",
    help="Disable loading all api nodes. Also prevents the frontend from communicating with the internet.",
)
...
def is_valid_directory(path: str) -> str:
    ...
    if not os.access(path, os.R_OK):
        raise argparse.ArgumentTypeError(
            f"You do not have read permissions for '{path}'."
        )
    return path
...
parser.add_argument(
    ...
    type=is_valid_directory,
    default=None,
    help="Set the ComfyUI user directory with an absolute path. Overrides --base-directory.",
)

parser.add_argument(
    "--enable-compress-response-body",
    action="store_true",
    help="Enable compressing response body.",
)
...
parser.add_argument(
    "--database-url",
    type=str,
    default=f"sqlite:///{database_default_path}",
    help="Specify the database URL, e.g. for an in-memory database you can use 'sqlite:///:memory:'.",
)
