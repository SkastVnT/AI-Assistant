"""Validate app/configs_vps/lora_registry.yaml against on-disk LoRA files.
...
Run from the repo root:
    ...
    python app/scripts/validate_lora_registry.py
    python app/scripts/validate_lora_registry.py --category character
    python app/scripts/validate_lora_registry.py --verbose
"""
...
REGISTRY_PATH = APP_ROOT / "configs_vps" / "lora_registry.yaml"
