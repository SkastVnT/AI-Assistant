...
echo "ðŸš€ Starting AI-Assistant services (except Hub)..."
...
# Start services
echo "ðŸ“¦ Starting ComfyUI (port 8189)..."
...
echo "ðŸ’¬ Starting Chatbot (port 5000)..."
...
echo "ðŸ—£ï¸  Starting Speech2Text (port 5001)..."
...
echo "ðŸ—„ï¸  Starting Text2SQL (port 5002)..."
...
echo "â³ Waiting 10 seconds for tunnels to initialize..."
sleep 10
...
echo "ðŸ“‹ Logs: /workspace/AI-Assistant/logs/"
