...
Usage:
    python app/scripts/scan_lora_inventory.py
        -> writes app/storage/lora_inventory.json

Cross-references entries against app/configs_vps/lora_registry.yaml and flags
...
REGISTRY = APP_ROOT / "configs_vps" / "lora_registry.yaml"
OUT = APP_ROOT / "storage" / "lora_inventory.json"
