...
class EditOperation:
    ...
    new_value: str | None = None  # for change/add ("white", "forest")
    modifier: str | None = None  # for modify ("darker", "bigger")
    raw_target: str | None = None  # original Vietnamese word (for debugging)
...
class SceneSpec:
    ...
    # Style & quality
    style: str | None = None  # "anime", "photorealistic", "sketch", …
    ...
    provider_hint: str | None = None  # force a specific provider name
    seed: int | None = None
...
class ImageGenerationRequest:
    ...
    quality: str = "auto"
    style: str | None = None
    provider: str | None = None  # force provider name
    model: str | None = None  # force model name
    width: int | None = None
