...
def list_models():
    ...
    models.sort(
        key=lambda m: (
            ...
            tier_order.get(m.get("tier", "standard"), 2),
        )
    )
...
def list_contexts():
    ...
    context_info = {
        "psychological": {
            ...
            "icon": "ðŸ§˜",
            "description": (
                "TÆ° váº¥n tÃ¢m lÃ½, há»— trá»£ cáº£m xÃºc"
                if language == "vi"
                else "Psychological counseling, emotional support"
            ),
        },
        "lifestyle": {
            ...
            "icon": "ðŸŒŸ",
            "description": (
                "TÆ° váº¥n lá»‘i sá»‘ng, phÃ¡t triá»ƒn báº£n thÃ¢n"
                if language == "vi"
                else "Lifestyle advice, personal development"
            ),
        },
        "casual": {
            ...
            "icon": "ðŸ’¬",
            "description": (
                "TrÃ² chuyá»‡n thÃ¢n thiá»‡n, Ä‘a chá»§ Ä‘á»"
                if language == "vi"
                else "Friendly chat, any topic"
            ),
        },
        "programming": {
            ...
            "icon": "ðŸ’»",
            "description": (
                "Coding, debug, kiáº¿n trÃºc pháº§n má»m"
                if language == "vi"
                else "Coding, debug, software architecture"
            ),
        },
        "creative": {
            ...
            "icon": "ðŸŽ¨",
            "description": (
                "Viáº¿t lÃ¡ch, brainstorm, thiáº¿t káº¿"
                if language == "vi"
                else "Writing, brainstorming, design"
            ),
        },
        "research": {
            ...
            "icon": "ðŸ”¬",
            "description": (
                "PhÃ¢n tÃ­ch chuyÃªn sÃ¢u, tá»•ng há»£p thÃ´ng tin"
                if language == "vi"
                else "Deep analysis, information synthesis"
            ),
        },
    }
...
def local_models_status():
    ...
    try:
        ...
        return (
            jsonify(
                {"available": False, "error": "Failed to retrieve local model status"}
            ),
            500,
        )
