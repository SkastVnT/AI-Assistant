...
class TestChatEndpoint:
    ...
    def test_chat_with_valid_message(self, client, sample_message):
        ...
        response = client.post(
            "/chat", json=sample_message, content_type="application/json"
        )
    ...
    def test_chat_with_missing_message(self, client):
        ...
        response = client.post(
            "/chat", json={"model": "gemini"}, content_type="application/json"
        )
    ...
    def test_chat_with_invalid_model(self, client):
        ...
        response = client.post(
            "/chat",
            json={"message": "Hello", "model": "invalid_model_xyz"},
...
class TestImageGenerationEndpoints:
    ...
    def test_generate_image_with_missing_prompt(self, client):
        ...
        response = client.post(
            "/api/generate-image", json={"steps": 20}, content_type="application/json"
        )
        assert response.status_code in [400, 500]
...
class TestMemoryEndpoints:
    ...
    def test_save_memory_endpoint(self, client):
        ...
        response = client.post(
            "/api/memory/save",
            json={"conversation_id": "test", "title": "Test Memory"},
            content_type="application/json",
        )
        assert response.status_code in [200, 400, 500]
...
class TestStorageEndpoints:
    ...
    def test_cleanup_storage(self, client):
        ...
        response = client.post("/api/storage/cleanup", content_type="application/json")
        assert response.status_code in [200, 404]
...
class TestExportEndpoints:
    ...
    def test_export_pdf_endpoint(self, client):
        ...
        response = client.post(
            "/export", json={"conversation_id": "test"}, content_type="application/json"
        )
...
class TestErrorHandling:
    ...
    def test_invalid_json(self, client):
        ...
        response = client.post(
            "/chat", data="not valid json", content_type="application/json"
        )
        assert response.status_code in [400, 500]
    ...
    def test_large_message(self, client):
        ...
        response = client.post(
            "/chat",
            json={"message": large_message, "model": "gemini"},
            content_type="application/json",
        )
    ...
    def test_missing_content_type(self, client):
        ...
        response = client.post("/chat", data=json.dumps({"message": "test"}))
...
class TestSecurity:
    ...
    def test_xss_in_message(self, client):
        ...
        response = client.post(
            "/chat",
            json={"message": xss_payload, "model": "gemini"},
            content_type="application/json",
        )
    ...
    def test_sql_injection_attempt(self, client):
        ...
        response = client.post(
            "/chat",
            json={"message": sql_payload, "model": "gemini"},
            content_type="application/json",
        )
