...
class TestChatAPIIntegration:
    ...
    def test_chat_gemini_integration(self, mock_gemini, client):
        ...
        response = client.post(
            "/chat",
            json={"message": "Hello", "model": "gemini", "context": "casual"},
    ...
    def test_chat_openai_integration(self, mock_openai, client):
        ...
        response = client.post(
            "/chat",
            json={"message": "Hello", "model": "gpt4", "context": "programming"},
            content_type="application/json",
        )
...
class TestFileUploadIntegration:
    ...
    def test_upload_python_file(self, client):
        ...
        response = client.post("/chat", json=file_data, content_type="application/json")
...
class TestImageGenerationIntegration:
    ...
    def test_text2img_integration(self, mock_post, client):
        ...
        response = client.post(
            "/api/generate-image",
            json={"prompt": "A beautiful landscape", "steps": 20, "cfg_scale": 7.5},
            content_type="application/json",
        )
...
class TestMemoryIntegration:
    ...
    def test_save_and_retrieve_memory(self, client):
        ...
        assert save_response.status_code in [200, 500] or get_response.status_code in [
            200,
            500,
        ]
...
class TestConversationFlow:
    ...
    def test_multi_turn_conversation(self, mock_gemini, client):
        ...
        response1 = client.post(
            "/chat",
            json={"message": "Hello", "model": "gemini", "session_id": session_id},
            content_type="application/json",
        )
