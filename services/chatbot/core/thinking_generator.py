...
def _detect_intent(message: str) -> tuple[str, str]:
    ...
    patterns = [
        (
            "greeting",
            r"(xin chào|chào|hello|hi |hey|good morning|good evening)",
            "Chào hỏi",
        ),
        (
            "code",
            r"(code|function|class|bug|error|debug|implement|refactor|api|"
        ...
        (
            "explain",
            r"(explain|giải thích|tại sao|why|how does|làm sao|như thế nào|cách)",
            "Giải thích",
        ),
        (
            "analysis",
            r"(analyze|analysis|compare|evaluate|phân tích|so sánh|đánh giá)",
            "Phân tích",
        ),
        (
            "creative",
            r"(write|story|poem|create|design|imagine|compose|draft|"
            r"viết|truyện|thơ|tạo|thiết kế|sáng tạo|soạn|bài viết)",
            "Sáng tạo",
        ),
        (
            "math",
            r"(calculate|math|equation|solve|formula|tính|toán|phương trình|giải)",
            "Toán học",
        ),
        (
            "translate",
            r"(translate|dịch|translation|bản dịch|chuyển ngữ|sang tiếng)",
            "Dịch thuật",
        ),
        ("summary", r"(summarize|summary|tóm tắt|tổng kết|overview|recap)", "Tóm tắt"),
        (
            "planning",
            r"(plan|strategy|roadmap|schedule|kế hoạch|chiến lược|lộ trình|quy trình)",
            "Lập kế hoạch",
        ),
        (
            "research",
            r"(research|study|paper|science|theory|nghiên cứu|khoa học|lý thuyết)",
            "Nghiên cứu",
        ),
        (
            "opinion",
            r"(what do you think|ý kiến|nghĩ gì|đánh giá|recommend|gợi ý|nên)",
            "Đánh giá",
        ),
    ]
    ...
    if category == "greeting":
        ...
        yield ThinkingStep(
            title=(
                ...
                if vi
                else "Analyzing technical requirements"
            ),
            description=(
                (
        ...
        yield ThinkingStep(
            title=(
                "Xây dựng lộ trình giải thích" if vi else "Building explanation roadmap"
            ),
            description=(
                (
        ...
        yield ThinkingStep(
            title=(
                "Phát triển ý tưởng sáng tạo" if vi else "Developing creative concept"
            ),
            description=(
                (
        ...
        yield ThinkingStep(
            title=(
                "Phân tích ngữ cảnh dịch thuật"
                if vi
                else "Analyzing translation context"
            ),
            description=(
                (
        ...
        yield ThinkingStep(
            title=(
                "Phân tích yêu cầu kế hoạch"
                if vi
                else "Analyzing planning requirements"
            ),
            description=(
                (
...
def generate_thinking_summary(
    ...
    summaries = {
        "greeting": (
            "Đã phân tích và chuẩn bị phản hồi",
            "Analyzed and prepared response",
        ),
        "code": (
            "Đã phân tích yêu cầu kỹ thuật và thiết kế giải pháp",
            "Analyzed technical requirements and designed solution",
        ),
        "explain": (
            "Đã xây dựng giải thích có cấu trúc",
            "Built structured explanation",
        ),
        "analysis": (
            "Đã phân tích đa chiều và tổng hợp kết luận",
            "Multi-dimensional analysis and synthesis complete",
        ),
        "creative": (
            "Đã phát triển ý tưởng và hoàn thiện nội dung",
            "Developed ideas and refined content",
        ),
        "math": (
            "Đã giải quyết bài toán theo từng bước",
            "Solved problem step by step",
        ),
        "translate": ("Đã phân tích và chuyển đổi ngôn ngữ", "Analyzed and translated"),
        "summary": (
            "Đã xác định và cô đọng nội dung chính",
            "Identified and condensed key content",
        ),
        "planning": (
            "Đã phân tích yêu cầu và xây dựng lộ trình",
            "Analyzed requirements and built roadmap",
        ),
        "research": (
            "Đã nghiên cứu và tổng hợp kiến thức",
            "Researched and synthesized knowledge",
        ),
        "question": (
            "Đã phân tích câu hỏi và xây dựng câu trả lời",
            "Analyzed question and built answer",
        ),
        "opinion": (
            "Đã đánh giá và chuẩn bị gợi ý",
            "Evaluated and prepared recommendation",
        ),
        "general": (
            "Đã phân tích và chuẩn bị câu trả lời",
            "Analyzed and prepared response",
        ),
        "complex": (
            "Đã phân tích yêu cầu phức tạp và hoàn thiện phản hồi",
