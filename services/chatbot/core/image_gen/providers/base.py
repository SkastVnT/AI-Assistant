...
class ImageRequest:
    ...
    source_image_b64: str | None = None  # for i2i / inpaint
    mask_b64: str | None = None  # for inpaint
    ...
    guidance: float = 3.5
    seed: int | None = None
    style_preset: str | None = None  # "photorealistic", "anime", etc.
    num_images: int = 1
    lora_models: list[LoraSpec] = field(default_factory=list)
    vae_name: str | None = None  # explicit VAE override
    checkpoint: str | None = None  # explicit checkpoint override
    preset_id: str | None = None  # workflow preset (e.g. "anime_character")
