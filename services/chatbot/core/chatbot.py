    ...
    def chat_with_openai(
        ...
        try:
            ...
            system_prompt = (
                ...
                else get_system_prompts(language).get(
                    context, get_system_prompts(language)["casual"]
                )
            )
...
def get_chatbot(session_id):
    ...
    from core.db_helpers import get_or_create_conversation, set_active_conversation
