...
class ImgBBUploader:
    ...
    def upload(
        self, image_data: str, title: str | None = None, expiration: int = 0
    ) -> dict[str, str] | None:
        """
        ...
        """
        try:
            logger.info("ðŸ“¤ Uploading base64 image to ImgBB...")
    ...
    def upload_image(
        self, image_path: str, title: str | None = None, expiration: int = 0
    ) -> dict[str, str] | None:
        """
...
# Quick helper
def upload_to_imgbb(image_path: str, title: str | None = None) -> str | None:
