...
class CacheManager:
    ...
    def cache_ai_response(
        self, model: str, message: str, context: str, response: str, ttl: int = 3600
    ) -> bool:
        """
    ...
    def get_ai_response(self, model: str, message: str, context: str) -> str | None:
    ...
    def get_sd_models(self) -> list | None:
        """Get cached SD models"""
        return self.get("sd_models")

    def cache_session_history(
        self, session_id: str, history: list, ttl: int = 1800
    ) -> bool:
        """
    ...
    def cache_file_analysis(
        self, file_hash: str, analysis: dict, ttl: int = 7200
    ) -> bool:
        """
    ...
    def get_file_analysis(self, file_hash: str) -> dict | None:
