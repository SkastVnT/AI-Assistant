...
class DatabaseManager:
    ...
    def _create_indexes(self):
        ...
        try:
            ...
            if (
                e.code == 86
            ):  # IndexKeySpecsConflict — indexes already exist with different options, safe to ignore
    ...
    def create_conversation(
        self, session_id: str, title: str = "New Chat", metadata: dict = None
    ) -> str | None:
        """
    ...
    def update_conversation(self, conversation_id: str, update: dict) -> bool:
    ...
    def batch_add_messages(self, messages: list[dict]) -> int:
        """
    ...
    def update_session_activity(self, session_id: str) -> bool:
        ...
        try:
            self.sessions.update_one(
                {"session_id": session_id}, {"$set": {"last_active": datetime.utcnow()}}
            )
            return True
        except Exception as e:
    ...
    def log_event(self, event_type: str, session_id: str, data: dict = None) -> bool:
        """
        Log analytics event
    ...
    def cleanup_old_data(self, days: int = 30) -> dict[str, int]:
        ...
        try:
            ...
            logger.info(
                f"ðŸ§¹ Cleanup: {analytics_result.deleted_count} analytics, "
