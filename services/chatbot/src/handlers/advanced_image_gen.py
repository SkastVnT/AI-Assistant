...
class AdvancedImageGenerator:
    ...
    def __init__(
        ...
        controlnet_models_path: str | None = None,
    ):
        """
    ...
    def _load_available_features(self):
        ...
        try:
            ...
            response = requests.get(
                f"{self.sd_api_url}/controlnet/model_list", timeout=5
            )
            ...
            response = requests.get(f"{self.sd_api_url}/sdapi/v1/upscalers", timeout=5)
            if response.status_code == 200:
        ...
        **kwargs,
        ...
        try:
            ...
            response = requests.post(
                f"{self.sd_api_url}/sdapi/v1/txt2img", json=payload, timeout=300
            )
    ...
    def _find_controlnet_model(self, controlnet_type: str) -> str | None:
        """Find matching ControlNet model"""
        type_keywords = {
            "canny": ["canny"],
            "depth": ["depth"],
        ...
        try:
            ...
            if restore_faces:
                payload["codeformer_visibility"] = (
                    1.0 if face_restorer == "CodeFormer" else 0.0
                )
    ...
    def inpaint_image(
        ...
        **kwargs,
        ...
        try:
            ...
            # Call SD API
            response = requests.post(
                f"{self.sd_api_url}/sdapi/v1/img2img", json=payload, timeout=300
            )
    ...
    def generate_with_multiple_loras(
        self, prompt: str, loras: list[dict[str, float]], **kwargs
    ) -> dict:
        """
    ...
    def get_capabilities(self) -> dict:
        ...
        return {
            ...
            "inpainting": {"enabled": self.is_available},
            "outpainting": {"enabled": self.is_available},
            "style_transfer": {"enabled": self.is_available},
            "lora_mixing": {"enabled": self.is_available},
        }
