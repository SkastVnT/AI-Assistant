...
class MessageRepository(BaseRepository):
    ...
    def get_conversation_messages(
        self, conversation_id: str, limit: int = 100, skip: int = 0, order: str = "asc"
    ) -> list[dict[str, Any]]:
        """
    ...
    def edit_message(
        self, message_id: str, new_content: str, reason: str = None
    ) -> dict[str, Any] | None:
        """
    ...
    def get_messages_by_role(
        self, conversation_id: str, role: str, limit: int = 50
    ) -> list[dict[str, Any]]:
        """
        ...
        """
        return self.get_many(
            query={"conversation_id": conversation_id, "role": role},
    ...
    def get_last_message(self, conversation_id: str) -> dict[str, Any] | None:
        """
    ...
    def get_last_user_message(self, conversation_id: str) -> dict[str, Any] | None:
        """
        ...
        """
        messages = self.get_many(
            query={"conversation_id": conversation_id, "role": "user"},
            sort=[("created_at", DESCENDING)],
            limit=1,
        )
