...
class BaseRepository(ABC, Generic[T]):
    ...
    def create_many(self, documents: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.debug(
                f"Created {len(documents)} documents in {self.collection_name}"
            )
            return documents
    ...
    def get_by_id(self, doc_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.error(
                f"Error getting document {doc_id} from {self.collection_name}: {e}"
            )
            return None
    ...
    def update(self, doc_id: str, updates: dict[str, Any]) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.error(
                f"Error updating document {doc_id} in {self.collection_name}: {e}"
            )
            raise
    ...
    def delete(self, doc_id: str) -> bool:
        ...
        try:
            ...
            logger.error(
                f"Error deleting document {doc_id} from {self.collection_name}: {e}"
            )
            raise
    ...
    def delete_many(self, query: dict[str, Any]) -> int:
        ...
        try:
            ...
            logger.debug(
                f"Deleted {result.deleted_count} documents from {self.collection_name}"
            )
    ...
    def soft_delete(self, doc_id: str) -> dict[str, Any] | None:
        """
        ...
        """
        return self.update(
            doc_id, {"is_deleted": True, "deleted_at": datetime.utcnow()}
        )
