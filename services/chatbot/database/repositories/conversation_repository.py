...
class ConversationRepository(BaseRepository):
    ...
    def get_user_conversations(
        ...
        return self.get_many(
            query=query, sort=[("updated_at", DESCENDING)], skip=skip, limit=limit
        )
    ...
    def archive_conversation(self, conversation_id: str) -> dict[str, Any] | None:
        """
        ...
        """
        return self.update(
            conversation_id, {"is_archived": True, "archived_at": datetime.utcnow()}
        )

    def unarchive_conversation(self, conversation_id: str) -> dict[str, Any] | None:
        """
        ...
        Returns:
            Updated conversation
        """
        return self.update(conversation_id, {"is_archived": False, "archived_at": None})
    ...
    def update_title(self, conversation_id: str, title: str) -> dict[str, Any] | None:
        """
    ...
    def increment_message_count(self, conversation_id: str) -> dict[str, Any] | None:
        """
    ...
    def get_recent_conversations(
        ...
        return self.get_many(
            query=query, sort=[("updated_at", DESCENDING)], limit=limit
        )
