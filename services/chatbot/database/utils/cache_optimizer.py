...
class CacheCompressor:
    ...
    def get_compression_stats(cls, original: Any, compressed: bytes) -> dict[str, Any]:
        ...
        return {
            ...
            "ratio": (
                round(compressed_size / original_size, 2) if original_size > 0 else 1
            ),
            "savings_percent": (
...
class CacheWarmer:
    ...
    def warm(self) -> dict[str, Any]:
        ...
        results = {"warmed": 0, "failed": 0, "duration_ms": 0}
        ...
        logger.info("Cache warming complete", extra=results)
        return results
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "utilization_percent": round(
                self._total_size / self.max_size_bytes * 100, 1
            ),
        }
