...
def main():
    ...
    parser.add_argument(
        "--skip-db", action="store_true", help="Skip database optimization"
    )
    parser.add_argument(
        "--log-days", type=int, default=30, help="Remove logs older than N days"
    )
    parser.add_argument(
        "--keep-backups", type=int, default=5, help="Number of backups to keep"
    )
