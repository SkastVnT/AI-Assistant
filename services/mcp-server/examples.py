...
def example_search_files():
    ...
    response = {
        ...
        "total_found": 3,
        "results": [
            {"filename": "app.py", "path": "services/chatbot/app.py", "size": 15420},
            {
...
def example_project_info():
    ...
    response = {
        ...
        "structure": {"config": True, "services": True, "tests": True, "docs": True},
...
def example_calculate():
    ...
    """
    response = {"expression": "sqrt(144)", "result": 12.0, "type": "float"}
    print("\nExample 6: Calculate")
    print(json.dumps(response, indent=2, ensure_ascii=False))
