...
const PORT = parseInt(process.env.AI_ASSISTANT_PORT || '5000', 10);
const REPO_ROOT = path.resolve(__dirname, '..', '..', '..'); // desktop/electron/src -> repo root
...
module.exports = { startBackend, HOST, PORT };
