...
const COPY_ITEMS = [
    ...
    { src: 'storage/character_loras',                         dst: 'storage/character_loras',                         required: false },
    { src: 'storage/character_refs',                          dst: 'storage/character_refs',                          required: false },
    { src: 'storage/feature_layers',                          dst: 'storage/feature_layers',                          required: false },
    { src: 'storage/metadata',                                dst: 'storage/metadata',                                required: false },
    { src: 'storage/prompts',                                 dst: 'storage/prompts',                                 required: false },
    { src: 'storage/references',                              dst: 'storage/references',                              required: false },
...
async function main() {
    ...
    if (!await fs.pathExists(py)) {
        ...
        console.warn('       See desktop/electron/PACKAGING.md for instructions.\n');
    }
