...
class TestProgressIsolation:
    ...
    def test_progress_isolation_between_clients(self, args_pytest):
        ...
        try:
            ...
            client_a_messages = client_a.progress_tracker.get_messages_for_prompt(
                prompt_id_a
            )
            client_b_messages = client_b.progress_tracker.get_messages_for_prompt(
                prompt_id_b
            )
            ...
            client_b_other = client_b.progress_tracker.get_messages_for_prompt(
                prompt_id_a
            )
    ...
    def test_progress_with_missing_client_id(self, args_pytest):
        ...
        try:
            ...
            image = graph.node(
                "StubImage", content="BLACK", height=128, width=128, batch_size=1
            )
