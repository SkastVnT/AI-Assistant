...
class TripoFileReference(RootModel):
    root: Union[
        TripoFileTokenReference,
        TripoUrlReference,
        TripoObjectReference,
...
class TripoTextToModelRequest(BaseModel):
    ...
    negative_prompt: Optional[str] = Field(
        None, description="The negative text prompt", max_length=1024
    )
    model_version: Optional[TripoModelVersion] = TripoModelVersion.v2_5_20250123
    face_limit: Optional[int] = Field(
        None, description="The number of faces to limit the generation to"
    )
    texture: Optional[bool] = Field(
        True, description="Whether to apply texture to the generated model"
    )
    pbr: Optional[bool] = Field(
        True, description="Whether to apply PBR to the generated model"
    )
    ...
    auto_size: Optional[bool] = Field(
        False, description="Whether to auto-size the model"
    )
    quad: Optional[bool] = Field(
        False, description="Whether to apply quad to the generated model"
    )


class TripoImageToModelRequest(BaseModel):
    type: TripoTaskType = Field(
        TripoTaskType.IMAGE_TO_MODEL, description="Type of task"
    )
    file: TripoFileReference = Field(
        ..., description="The file reference to convert to a model"
    )
    model_version: Optional[TripoModelVersion] = Field(
        None, description="The model version to use for generation"
    )
    face_limit: Optional[int] = Field(
        None, description="The number of faces to limit the generation to"
    )
    ...
    texture_quality: Optional[TripoTextureQuality] = TripoTextureQuality.standard
    geometry_quality: Optional[TripoGeometryQuality] = TripoGeometryQuality.standard
    texture_alignment: Optional[TripoTextureAlignment] = Field(
        TripoTextureAlignment.ORIGINAL_IMAGE, description="The texture alignment method"
    )
    style: Optional[TripoStyle] = Field(
        None, description="The style to apply to the generated model"
    )
    auto_size: Optional[bool] = Field(
        False, description="Whether to auto-size the model"
    )
...
class TripoMultiviewToModelRequest(BaseModel):
    ...
    files: List[TripoFileReference] = Field(
        ..., description="The file references to convert to a model"
    )
    model_version: Optional[TripoModelVersion] = Field(
        None, description="The model version to use for generation"
    )
    orthographic_projection: Optional[bool] = Field(
        False, description="Whether to use orthographic projection"
    )
    face_limit: Optional[int] = Field(
        None, description="The number of faces to limit the generation to"
    )
    ...
    texture_quality: Optional[TripoTextureQuality] = TripoTextureQuality.standard
    geometry_quality: Optional[TripoGeometryQuality] = TripoGeometryQuality.standard
    texture_alignment: Optional[TripoTextureAlignment] = (
        TripoTextureAlignment.ORIGINAL_IMAGE
    )
    auto_size: Optional[bool] = Field(
        False, description="Whether to auto-size the model"
    )
    orientation: Optional[TripoOrientation] = Field(
        TripoOrientation.DEFAULT, description="The orientation for the model"
    )
    quad: Optional[bool] = Field(
        False, description="Whether to apply quad to the generated model"
    )
...
class TripoTextureModelRequest(BaseModel):
    ...
    original_model_task_id: str = Field(
        ..., description="The task ID of the original model"
    )
    texture: Optional[bool] = Field(
        True, description="Whether to apply texture to the model"
    )
    pbr: Optional[bool] = Field(True, description="Whether to apply PBR to the model")
    model_seed: Optional[int] = Field(None, description="The seed for the model")
    texture_seed: Optional[int] = Field(None, description="The seed for the texture")
    texture_quality: Optional[TripoTextureQuality] = Field(
        None, description="The quality of the texture"
    )
    texture_alignment: Optional[TripoTextureAlignment] = Field(
        TripoTextureAlignment.ORIGINAL_IMAGE, description="The texture alignment method"
    )
...
class TripoAnimatePrerigcheckRequest(BaseModel):
    type: TripoTaskType = Field(
        TripoTaskType.ANIMATE_PRERIGCHECK, description="Type of task"
    )
    original_model_task_id: str = Field(
        ..., description="The task ID of the original model"
    )
...
class TripoAnimateRigRequest(BaseModel):
    ...
    out_format: Optional[TripoOutFormat] = Field(
        TripoOutFormat.GLB, description="The output format"
    )
    spec: Optional[TripoSpec] = Field(
        TripoSpec.TRIPO, description="The specification for rigging"
    )


class TripoAnimateRetargetRequest(BaseModel):
    type: TripoTaskType = Field(
        TripoTaskType.ANIMATE_RETARGET, description="Type of task"
    )
    original_model_task_id: str = Field(
        ..., description="The task ID of the original model"
    )
    ...
    bake_animation: Optional[bool] = Field(
        True, description="Whether to bake the animation"
    )
...
class TripoConvertModelRequest(BaseModel):
    ...
    force_symmetry: Optional[bool] = Field(
        None, description="Whether to force symmetry"
    )
    face_limit: Optional[int] = Field(
        None, description="The number of faces to limit the conversion to"
    )
    flatten_bottom: Optional[bool] = Field(
        None, description="Whether to flatten the bottom of the model"
    )
    flatten_bottom_threshold: Optional[float] = Field(
        None, description="The threshold for flattening the bottom"
    )
    texture_size: Optional[int] = Field(None, description="The size of the texture")
    texture_format: Optional[TripoTextureFormat] = Field(
        TripoTextureFormat.JPEG, description="The format of the texture"
    )
    pivot_to_center_bottom: Optional[bool] = Field(
        None, description="Whether to pivot to the center bottom"
    )
    scale_factor: Optional[float] = Field(
        None, description="The scale factor for the model"
    )
    with_animation: Optional[bool] = Field(
        None, description="Whether to include animations"
    )
    ...
    part_names: Optional[List[str]] = Field(
        None, description="The names of the parts to include"
    )
    fbx_preset: Optional[TripoFbxPreset] = Field(
        None, description="The preset for the FBX export"
    )
    export_vertex_colors: Optional[bool] = Field(
        None, description="Whether to export the vertex colors"
    )
    export_orientation: Optional[TripoOrientation] = Field(
        None, description="The orientation for the export"
    )
    animate_in_place: Optional[bool] = Field(
        None, description="Whether to animate in place"
    )
...
class TripoTask(BaseModel):
    ...
    status: Optional[TripoTaskStatus] = Field(
        None, description="The status of the task"
    )
    input: Optional[Dict[str, Any]] = Field(
        None, description="The input parameters for the task"
    )
    output: Optional[TripoTaskOutput] = Field(
        None, description="The output of the task"
    )
    progress: Optional[int] = Field(
        None, description="The progress of the task", ge=0, le=100
    )
    create_time: Optional[int] = Field(
        None, description="The creation time of the task"
    )
    running_left_time: Optional[int] = Field(
        None, description="The estimated time left for the task"
    )
