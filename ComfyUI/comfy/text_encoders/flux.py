...
def load_mistral_tokenizer(data):
    ...
    try:
        ...
        from transformers.models.pixtral.convert_pixtral_weights_to_hf import (
            MistralConverter,
        )
...
class Mistral3Tokenizer(sd1_clip.SDTokenizer):
    def __init__(self, embedding_directory=None, tokenizer_data={}):
        ...
        super().__init__(
            ...
            tokenizer_class=MistralTokenizerClass,
            has_end_token=False,
            pad_to_max_length=False,
            pad_token=11,
            max_length=99999999,
            min_length=1,
            pad_left=True,
            tokenizer_args=load_mistral_tokenizer(self.tekken_data),
            tokenizer_data=tokenizer_data,
        )
...
class Flux2Tokenizer(sd1_clip.SD1Tokenizer):
    ...
    def tokenize_with_weights(
        self, text, return_word_ids=False, llama_template=None, **kwargs
    ):
...
class Mistral3_24BModel(sd1_clip.SDClipModel):
    def __init__(
        ...
        super().__init__(
            ...
            dtype=dtype,
            special_tokens={"start": 1, "pad": 0},
            layer_norm_hidden_state=False,
            model_class=comfy.text_encoders.llama.Mistral3Small24B,
